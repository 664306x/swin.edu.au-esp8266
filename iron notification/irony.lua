...
TIME_BURN_ALARM = 20000  -- Time expended before triggering an alert for iron left horizontal (20 seconds)
TIME_UNUSED_ALARM = 300000  -- Time expended before triggering an alert for iron left idle (standing) (3 minutes)
...
BURN_MESSAGE = "Aargh it buuuurns...\n" -- Sent when TIME_BURN_ALARM is exceeded
UNUSED_MESSAGE = "Hey it's your iron, you forgot to turn me off!\n" -- Sent when TIME_UNUSED_ALARM is exceeded
